...
<html>
    ...
    <body>
        ...
        <main id="area_conteudo">
            <!-- PRODUTOS EM PROMOÇÃO DO SITE -->
            <!-- PROMOÇÃO UM -->
            <div id="promocao_um">
                <div class="img_promocao">
                    <div class="promo"><h2 class="style_promo">Promoção</h2></div>
                    <img src="imagens/produtos/laranja.png" alt="Suco de Laranja">
                </div>
                <div class="descricao">
                    Suco de Laranja<br>
                    100% Natural<br>
                    <p><span style="text-decoration: line-through; color: #ffa31a;"> R$ 6,50 </span></p> R$ 5,00
                </div>
                <div class="botao">
                    <a href="#">
                        Detalhes
            ...
            <!-- PROMOÇÃO DOIS -->
            <div id="promocao_dois">
                <div class="img_promocao">
                    <div class="promo"><h2 class="style_promo">Promoção</h2></div>
                    <img src="imagens/produtos/maracuja.png" alt="Suco de Maracujá">
                </div>
                <div class="descricao">
                    Suco de Maracujá<br>
                    100% Natural<br>
                    <p><span style="text-decoration: line-through; color: #ffa31a;"> R$ 9,50 </span></p> R$ 8,00
                </div>
                <div class="botao">
                    <a href="#">
                        Detalhes
